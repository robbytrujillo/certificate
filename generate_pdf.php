...
if ($result->num_rows > 0) {
    ...
    // Menentukan posisi teks Nama Peserta
    $pdf->SetXY(0, 80); // Atur posisi vertikal di bawah "Diberikan kepada"
    $pdf->Cell(297, 10, strtoupper($row['nama_pegawai']), 0, 1, 'C'); // Posisi di tengah halaman
